...
interface OnboardingFoodPreferences4ScreenProps {
...
export const OnboardingFoodPreferences4Screen: React.FC<OnboardingFoodPreferences4ScreenProps> = ({
  ...
  const handleNext = async () => {
    try {
      ...
      const foodData = {
        cuisinesToAvoid: selectedCuisines,
      };
      ...
      if (success) {
        console.log('✅ [OnboardingFoodPreferences4Screen] Saved successfully');
        onNavigate?.('onboarding-interests', foodData);
      } else {
      ...
      console.error('❌ [OnboardingFoodPreferences4Screen] Error saving:', error);
      Alert.alert('Error', 'An unexpected error occurred. Please try again.');
    }
  };

  const handleBack = () => {
    onNavigate?.('onboarding-food-3');
  };
