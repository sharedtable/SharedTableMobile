...
import { useNavigation, useRoute, RouteProp as ReactNavigationRouteProp } from '@react-navigation/native';
...
type RouteProp = ReactNavigationRouteProp<AuthStackParamList, 'SignIn'>;
...
export const SignInScreen = memo<SignInScreenProps>((props) => {
  const { onNavigate } = props;
  const navigation = useNavigation<NavigationProp>();
  const route = useRoute<RouteProp>();
  const hasInvitation = route.params?.hasInvitation || false;
